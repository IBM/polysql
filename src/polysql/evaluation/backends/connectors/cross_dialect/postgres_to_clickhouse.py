"""PostgreSQL to ClickHouse cross-dialect connector."""
...
class PostgresToClickHouseConnector(BaseBackendConnector):
    """Connector for loading PostgreSQL data into ClickHouse backend."""

    def __init__(self):
        """Initialize PostgreSQL to ClickHouse connector."""
    ...
    def connect(
        ...
        """Connect to ClickHouse and optionally load data from PostgreSQL."""
    ...
    def _load_data_with_dlt(
        ...
        """Load data from PostgreSQL source to ClickHouse using dlt."""
        ...
        pipeline = dlt.pipeline(
            pipeline_name=f"postgres_to_clickhouse_{dataset_name}",
